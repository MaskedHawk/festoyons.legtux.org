...
class Users extends Admin_Controller
{
    ...
    {
        $this->data['page_title'] = 'Festoyons - Administrateur';
    ...
    {
        $this->data['page_title'] = 'Festoyons - Ajout d\'administrateur';
    ...
    public function edit($user_id = NULL)
    {
        ...
        $this->data['page_title'] = 'Festoyons - Modification du profil';
        $this->load->library('form_validation');
    ...
    public function accept($user_id = NULL)
    {
        ...
        $reffered_from = $this->session->userdata('referred_from');
        if($reffered_from == NULL) $reffered_from = 'admin/dashboard';
        redirect($reffered_from,'refresh');
    }
